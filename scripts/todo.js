...
emptyNewRow = emptyNewRow + "<td class='tdIsDone'><select class='txtIsDone' name='IsDone' placeholder='Enter Is Done'><option value='Yes'>Yes</option><option value='No'>No</option></select></td>";    
...
$('#data').on('click', '.btnEdit', function () { 
    ...
    $(this).parent().parent().find(".tdIsDone").html("<select class='txtIsDone' value = '"+isDone+"' name='IsDone' placeholder='Enter Is Done'><option value='Yes'>Yes</option><option value='No'>No</option></select>");
