...
emptyNewRow = emptyNewRow + "<td class='tdIsDone'><input type='checkbox' class='txtIsDone' name='True' value='No'><label for='True'> Yes </label><input type='checkbox' class='txtIsDone' name='False' value='No'><label for='False'> No </label> </td>";    
...
$('#data').on('click', '.btnEdit', function () { 
    ...
    $(this).parent().parent().find(".tdDescription").html("<input type='text' value='"+description+"' class=txtDescription' placeholder='Enter Description'/>"); 
